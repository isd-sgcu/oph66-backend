...
type Cache interface {
	...
	Set(ctx context.Context, key string, value *FeatureFlag, cacheDuration time.Duration) *apperror.AppError
}
...
func (c *cacheImpl) Set(ctx context.Context, key string, value *FeatureFlag, cacheDuration time.Duration) *apperror.AppError {
	prefixedKey := cacheKeyPrefix + key
